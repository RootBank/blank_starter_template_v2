...
console.log('');
console.log('━'.repeat(60));
console.log('  STEP 1 — Paste this into code/core/container.setup.ts');
console.log('           (replace the TODO comment block for PROVIDER_CLIENT)');
console.log('━'.repeat(60));
console.log('');
console.log(`  container.register(`);
console.log(`    ServiceToken.PROVIDER_CLIENT,`);
console.log(`    () => new (require('../clients/${provider}-client').default)(),`);
console.log(`    ServiceLifetime.SINGLETON`);
console.log(`  );`);
console.log('');
console.log(`  container.register(`);
console.log(`    ServiceToken.PROVIDER_SERVICE,`);
console.log(`    (c) => {`);
console.log(`      const logService = c.resolve(ServiceToken.LOG_SERVICE);`);
console.log(`      const client = c.resolve(ServiceToken.PROVIDER_CLIENT);`);
console.log(`      const { ${Provider}Service } = require('../services/${provider}.service');`);
console.log(`      return new ${Provider}Service(logService, client);`);
console.log(`    },`);
console.log(`    ServiceLifetime.SINGLETON`);
console.log(`  );`);
console.log('');
console.log('━'.repeat(60));
console.log('  STEP 2 — Wire webhooks in code/webhook-hooks.ts');
console.log('━'.repeat(60));
console.log('');
console.log(`  // Uncomment Step 1 (signature verification) and Step 3 (event routing).`);
console.log(`  // Add this import at the top of webhook-hooks.ts:`);
console.log(`  import { ${Provider.toUpperCase()}_EVENTS } from './interfaces/${provider}-events';`);
console.log('');
console.log(`  // Then route events using the generated constants:`);
console.log(`  switch (payload.type) {`);
console.log(`    case ${Provider.toUpperCase()}_EVENTS.PAYMENT_COMPLETED: { ... break; }`);
console.log(`    case ${Provider.toUpperCase()}_EVENTS.PAYMENT_FAILED:    { ... break; }`);
console.log(`  }`);
console.log('');
console.log('━'.repeat(60));
console.log('  STEP 3 — Implement service methods');
console.log('━'.repeat(60));
console.log('');
console.log(`  code/services/${provider}.service.ts`);
console.log('  → Each method has a TODO — replace with real API calls via this.providerClient.sdk');
console.log('  → Use retryWithBackoff() for network calls (already imported)');
console.log('');
console.log('  STEP 4 — Wire lifecycle hooks');
console.log('  code/lifecycle-hooks/policy.hooks.ts  → afterPolicyIssued, afterPolicyCancelled');
...
import { retryWithBackoff, ModuleError } from '../utils';
